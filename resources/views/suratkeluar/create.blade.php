...
<form action="{{ route('suratkeluars.store') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
      <div class="col">
        ...
        <input type="text" name="nosurat" class="form-control @if($errors->has('nosurat')) is-invalid @endif" 
  ...
  <div class="row mt-3">
      <div class="col">
        ...
        <input type="text" name="tujuan" class="form-control @if($errors->has('tujuan')) is-invalid @endif" placeholder="Masukkan Tujuan Surat" value="{{old('tujuan')}}">                  
