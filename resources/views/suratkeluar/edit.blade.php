...
<form action="{{ route('suratkeluars.update', $suratkeluar->id) }}" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
      <div class="col">
        ...
        <input type="text" name="no_surat" class="form-control @if($errors->has('no_surat')) is-invalid @endif" placeholder="Masukkan No. Surat" value="{{$suratkeluar->no_surat}}">                  
  ...
  <div class="row mt-3">
      <div class="col">
        ...
        <input type="text" name="tujuan" class="form-control @if($errors->has('tujuan')) is-invalid @endif" placeholder="Masukkan Tujuan Surat" value="{{$suratkeluar->pengirim}}">                  
  ...
  <div class="row mt-3">
      <div class="col">
        ...
        <a href="{{url('suratkeluarfile/'.$suratmasuk->file_surat)}}" target="_blank" class="btn btn-sm btn-info"><i class="fa fa-file"></i> Lihat File</a>            
          @if($errors->has('file'))
          <br>
          <small class="text-danger">
            {{$errors->first('file')}}
